...
function setup() {
	...
	//redBox1Sprite=createSprite(width/2,height-53,400,25)
	//redBox1Sprite.shapeColor=color(255,8,0);
	...
	//redBox1 = Bodies.rectangle(width/2,650,width,10,{isStatic:true});
	//World.add(world, redBox1);

	redBox2 = Bodies.rectangle(width/2,600,width,10,{isStatic:true});
